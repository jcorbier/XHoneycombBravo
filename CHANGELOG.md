...
### Added
- **Honeycomb Bravo Lite support**: added support for the Honeycomb Bravo Lite.

### Fixed
- **macOS IOKit function declarations**: fixed missing or incomplete function declarations in the macOS HID implementation.

## [0.5.0] - 2026-08-24

### Changed
- **Notarize plugin for macOs.**
...
[Unreleased]: https://github.com/jcorbier/XHoneycombBravo/compare/v0.6.0...HEAD
[0.6.0]: https://github.com/jcorbier/XHoneycombBravo/releases/tag/v0.6.0
[0.5.0]: https://github.com/jcorbier/XHoneycombBravo/releases/tag/v0.5.0
